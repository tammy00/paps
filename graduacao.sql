...
--
-- Host: 127.0.0.1
-- Generation Time: 20-Jan-2016 às 20:19
...
ALTER TABLE `comissao`
 ADD PRIMARY KEY (`id`), ADD KEY `idProfessor` (`idProfessor`);
...
--
ALTER TABLE `comissao`
ADD CONSTRAINT `comissao_ibfk_1` FOREIGN KEY (`idProfessor`) REFERENCES `usuario` (`id`);
